export const features = [
  {
    ...
    title: "Stay safer, not just smarter.",
    text: "With Safe Steps, panic is no longer paralyzing. Smart triggers and automation ensure help is on the way—fast. It's like having a lifeline at your fingertips, without needing to think twice.",
    button: {
  ...
  },
  {
    ...
    title: "Feel secure, we got your back.",
    text: "Your safety is our priority. With secure communication protocols and real-time location sharing, Safe Steps ensures your alerts reach the right people.",
    button: {
...
export const details = [
  {
    ...
    title: "Emergency-triggered video recording",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Connect with your trusted contacts",
  },
  {
    id: "2",
...
export const faq = [
  {
    id: "0",
    question: " What is Safe Steps?",
    answer:
      "Safe Steps is a safety solution with a wearable device and mobile app for quick emergency alerts.",
  },
  {
    id: "1",
    question: "How does the SOS button work?",
    answer:
      "Hold the button for 5 seconds to send your location and call a registered contact.",
  },
  {
    id: "2",
    question: "Can I use Safe Steps without the hardware?",
    answer:
      "Yes, the mobile app alone can trigger emergency alerts using volume buttons.",
  },
  {
    id: "3",
    question: "What happens when I trigger an alert?",
    answer:
      "An SMS with your live location is sent, and a call is placed to your emergency contacts.",
  },
  {
    id: "4",
    question: "How many contacts can I register?",
    answer:
      "You can register up to 5 emergency contacts.",
  },
  {
    id: "5",
    question: "Does it work without internet?",
    answer:
      "Yes, the hardware uses GSM for SMS and calls, even without internet.",
  },
  {
    id: "6",
    question: "What phone permissions are needed?",
    answer:
      "The app needs SMS, call, location, and camera permissions.",
  },
  {
    id: "7",
    question: " Is video recording automatic?",
    answer:
      "Yes, during an emergency, the app records 3-minute video clips automatically.",
  },
  {
    id: "8",
    question: " Is my data safe?",
    answer:
      "Yes, all data and communications are secured with encryption.",
  },
  {
    id: "9",
...
export const testimonials = [
  {
    ...
    comment:
      "Safe Steps gave me peace of mind during a late-night commute. One press, and my family knew exactly where I was.",
  },
  {
    id: "1",
    name: "John D.",
